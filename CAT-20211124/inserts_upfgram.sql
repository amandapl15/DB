...
INSERT INTO `user` (id, user_name, `name`, surname, birthday_date, gender) VALUES
(1,"anna_97","Anna","Puigvert","1997-1-1","F"),
...
INSERT INTO follow (userid_follow, userid_followed, follow_datetime) VALUES
(1,2,"2021-11-10 20:30:0"),
...
INSERT INTO `post`(id, user_write_id, post_datetime, reply_to_post_id, `text`) VALUES 
(1,	1,"2021-11-28 18:43:33",NULL,	"La bretxa salarial a Espanya és del 14,2%. Això vol dir que des d`avui fins a final d`any, les dones espanyoles treballaran de franc"),
...
(19,9,"2021-11-10 11:03:12",	9,	"Bon any!"),
...
-- select * from feedback;
 ...
 /*tabla belongs*/
INSERT INTO belongs (user_id, group_id) VALUES
(1,2),
(1,4),
(1,5),
(2,1),
